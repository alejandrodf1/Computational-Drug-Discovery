# Computational Drug Discovery Project guide installation
...
activate computational_drug_discovery_project
```
...
To move beyond notebook prototyping, all reusable code should go into the `computational_drug_discovery_project/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `computational_drug_discovery_project` folder and use the modules inside your notebooks :
...
```python
from computational_drug_discovery_project.utils.paths import data_dir
data_dir()
```
